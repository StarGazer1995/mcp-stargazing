...
def run_pagination_demo():
    ...
    try:
        ...
        print(
            'Ensure the server is running with: python -m src.main --mode shttp --port 3001 --proxy http://127.0.0.1:7890'
        )
        return
    ...
    resp_p1 = call_tool(
        'analysis_area', {**search_params, 'page': 1, 'page_size': 5}, HOST, PORT, PATH, session_id
    )
