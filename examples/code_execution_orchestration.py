...
def orchestrate_workflow():
    ...
    _, dt_resp = call_tool(
        'get_local_datetime_info', {}, host=host, port=port, path=path, session_id=session_id
    )
        ...
        try:
            ...
            if total > 2:
                ...
                if p2_content:
                    ...
                    print(
                        f'  -> Page 2 has {len(p2_data.get("items", []))} items. Resource ID: {p2_data.get("resource_id")}'
                    )
